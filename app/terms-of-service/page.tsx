...
export const metadata: Metadata = {
  title: "Terms of Service | Lunar Fortis",
  description: "Read our Terms of Service to learn about your rights and responsibilities as a user of Lunar Fortis.",
};
...
// Simplified version with only the sections shown in your screenshot
const TERMS_SECTIONS = [
  {
    id: "admin",
    title: "1. Who is the Admin?",
...
// Additional sections based on typical Terms of Service
const ADDITIONAL_SECTIONS = [
  ...
  {
    id: "updates",
    title: "9. Updates to this Privacy Notice",
    content: "We may update this Privacy Notice from time to time to reflect changes in our practices or legal requirements. We will notify you of any significant changes by posting the updated notice on our website and updating the 'Last Updated' date at the top.",
  },
  {
    id: "contact",
    title: "10. Contact Us",
    content: "If you have any questions about this Privacy Notice or our data practices, please contact us at:\n\nCareer pro Technologies Limited\nEmail: hello@lunafortis.com",
  },
];
        ...
        <section className="bg-[#0D1B2A] text-white py-12 px-4">
          <div className="max-w-[1280px] mx-auto">
            ...
            <p className="text-white/70 text-lg max-w-2xl">
              Read our Terms below to learn more about your rights and responsibilities as our user.
            </p>
            ...
            <div>
              ...
              <div className="mb-8">
                <div className="bg-[#EEF3F8] rounded-xl px-6 py-3 text-sm text-[#0D1B2A]">
                  <span className="font-semibold">Updated March 17, 2025</span>
                </div>
              </div>
              ...
              <div className="space-y-8">
                {TERMS_SECTIONS.map((section) => (
                  <div key={section.id} className="border-b border-[#E5E7EB] pb-8 last:border-b-0 last:pb-0">
                    <h2 className="text-xl font-bold text-[#0D1B2A] mb-3">{section.title}</h2>
            ...
            <div>
              <div className="sticky top-24">
                ...
                <nav className="space-y-2">
                  {[...TERMS_SECTIONS, ...ADDITIONAL_SECTIONS].map((section) => (
                    <a
                      key={section.id}
                      href={`#${section.id}`}
                ...
                <div className="mt-8 p-5 bg-[#EEF3F8] rounded-xl">
                  <h4 className="text-sm font-semibold text-[#0D1B2A] mb-2">Questions?</h4>
