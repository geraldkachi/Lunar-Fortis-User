...
export const metadata: Metadata = {
  ...
  keywords: ["security escort Lagos","car rental Lagos","shortlet apartment Lagos","chauffeur service Nigeria","luxury accommodation Lekki"],
  openGraph: {
    type: "website",
    locale: "en_NG",
    ...
    description: "Experience elite protection, refined mobility, and trusted accommodation.",
  },
};
